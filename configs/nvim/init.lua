...
require("lazy").setup({
  ...
  -- file explorer
  {
    ...
    opts = {
      ...
      commands = {
        -- copied from https://github.com/nvim-neo-tree/neo-tree.nvim/discussions/370#discussioncomment-6679447
        copy_path_selector = function(state)
